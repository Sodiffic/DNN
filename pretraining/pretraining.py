...
from configuration import BertCLIPConfig
'''
本部分用于完成clip预训练部分。

'''
class BertCLIPModel(CLIPPreTrainedModel):
    config_class = BertCLIPConfig #来自configuration，图像特征提取模块config待修改。
    ...
    def __init__(self, config: BertCLIPConfig):
        ...
        # 将文本encoder修改为bert
        #TODO:修改vision_model CLIPVisionTransformer模型
